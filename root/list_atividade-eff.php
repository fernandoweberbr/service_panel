			...
			if($users['id_users'])
			{
				...
				{	
					if(if_ordem_exist(trim($dadosCon['num_ordem']))==True)
					{
						...
						print('<tr><td><text class="text-light" style="font-size: 1.1vw">'.$dadosCon['num_ordem'].'</text></td>');print("\r\n");
						print('<td><text class="text-light" style="font-size: 1.1vw">'.$dadosCon['at_descricao'].'</text></td>');print("\r\n");
						//print('<td><text class="text-light" style="font-size: 1.5vw">'.$dadosCon['d_data_inicio'].'</text></td>');print("\r\n");
						...
						if(strtotime($dadosCon['d_data_inicio'])>0)
						{
							...
							if($dias>0)
							{
								if($dias>1 && $dias<3){
									...
									if($dias<0){
										print('<td><text class="text-dask bg-danger" style="font-size: 1.1vw">'.$data_inicio.' Atraso '.abs($dias).' dia(s) ['.$data_final.']</text></td>');
									} else {
										if($dias==0){
											print('<td><text class="text-dark bg-warning" style="font-size: 1.1vw">Hoje  '.$data_inicio.', ['.$data_final.']</td>');
										} 
									}
							}
						} else {
							print('<td><text class="text-dark bg-warning" style="font-size: 1.1vw">X</text></td>');
						}
						print("</tr>\r\n");
					}
					else 
