            ...
            <table id="setor_grid" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-column-id="usuario_alias">Alias</th>
                        <th data-column-id="nivel_usuario">nivel</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" id="frm_edit">
                            ...
                            <div class="form-group">
                                <label for="nivel" class="control-label">Nivel:</label>
                                <input type="text" class="form-control" id="edit_nivel" name="edit_nivel" />
                            </div>
                            <div class="form-group">
                                <label for="senha" class="control-label">Senha:</label>
                                <input type="text" class="form-control" id="edit_senha" name="edit_senha" />
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
            ...
            var grid = $("#setor_grid").bootgrid({
                ...
                grid.find(".command-edit").on("click", function (e) {
                    ...
                    if ($(this).data("row-id") > 0) {
                        ...
                        $('#edit_nivel').val(ele.siblings(':nth-of-type(4)').html());
                        $('#edit_senha').val(ele.siblings(':nth-of-type(5)').html());
                    } else {
                    ...
                    if ($(this).data("row-id") > 0) {
                        ...
                        alert(conf);
                        if (conf) {
                            $.post('resp_usuario.php', { id: $(this).data("row-id"), action: 'delete' }
                                , function () {
